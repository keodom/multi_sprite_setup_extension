...
namespace multiSpriteSetup {
    ...
    //% myImage3.shadow=screen_image_picker
    //% myImage4.shadow=screen_image_picker
    export function spriteSetUp(myImage: Image, myImage2: Image, myImage3: Image, myImage4: Image) {
        ...
        for (let index = 0; index <= 3; index++) {
            ...
            mp.getPlayerSprite(mp.getPlayerByIndex(index)).x = index * 40 + 20
        }
    }
